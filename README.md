...
- иметь практический опыт	В участии в соадминистрировании серверов;

- разработке политики безопасности SQL сервера, базы данных и отдельных объектов базы данных; 

- применении законодательства Российской Федерации в области сертификации программных средств информационных технологий уметь	проектировать и создавать базы данных;

- выполнять запросы по обработке данных на языке SQL; осуществлять основные функции по администрированию баз данных; 

- разрабатывать политику безопасности SQL сервера, базы данных и отдельных объектов базы данных; 

- владеть технологиями проведения сертификации программного средства знать	модели данных, основные операции и ограничения; 
...
- создать тестовую базу данных в СУБД с выгрузкой из внешнего файла ([репозиторий тут]()), не менее 5 таблиц, в таблице не менее 5 записей;
